...
const SecondPage = () => (
  <Layout>
    <About>
      ...
      <p>This site was built with <a href="#0">Gatsby</a> the source is available on <a href="#0">Github</a>. I take <Link to="notes">notes for future refrence</Link> and save what I'm reading on <a href="https://www.goodreads.com/user/show/3196623-thomas-green">Goodreads</a>.</p>
      <p><strong>Want to work together?</strong> <a href="#0">Send&nbsp;me&nbsp;an&nbsp;email</a>&nbsp;&rarr;</p>
    </About>
  </Layout>
)
